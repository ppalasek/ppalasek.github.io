...
### (generirano 17.11.2022. 13:52:53 h)
...
![](img/2022_11_16_line_plots.png)

## Pregled tjedne promjene broja zaraženih po županijama

![](img/2022_11_16_map.png)

## Kretanje broja umrlih

![](img/2022_11_16_deaths_shaded.png)

## Kretanje broja COVID-19 slučajeva, hospitalizacija i umrlih

(napomena: podaci o hospitalizacijama i broju osoba na respiratorima se ne objavljuju svakodnevno, prikazani su zadnji dostupni podaci)

![](img/2022_11_16_cases_hospitalisations_deaths_perc.png)

![](img/2022_11_16_cases_hospitalisations_deaths_perc_log.png)

![](img/2022_11_16_cases_hospitalisations_deaths_log_age.png)

## Kretanje udjela pozitivnih testova

(zadnji dostupni podaci s HZJZ, plavom bojom prikazani su podaci s koronavirus_hr twittera)

![](img/2022_11_16_percentage_positive_tests.png)

## Kretanje broja učinjenih testova

(zadnji dostupni podaci s HZJZ, plavom bojom prikazani su podaci s koronavirus_hr twittera)

![](img/2022_11_16_num_tests.png)

## Kretanje broja COVID-19 slučajeva na 100 tisuća stanovnika po dobnim skupinama

![](img/2022_11_16_cases_per_age_group_lines.png)

![](img/2022_11_16_cases_per_age_group_lines_log.png)
...
| Dobna skupina | Na 100k stanovnika<br>u 7 dana do 14.11.2022. | 1 na svakih | Promjena u odnosu<br>na prošli tjedan |
| :-----------: | :----------------: | :---------: | :--------------------------------: |
| 0-4 | 15 | 6751 | -4% |
| 5-9 |  8 | 12960 | -39% |
| 10-14 | 18 | 5584 | -10% |
...
![](img/2022_11_16anim_aug_1200.gif)

![](img/anim_cases_2022_11_16_vs_2020.gif)

![](img/2022_11_16all_counties_dots.png)

## Ukupan broj zaraženih u zadnjih 7 dana na 100000 stanovnika

![](img/2022_11_16_map_7_day_per_100k.png)

## Ukupan broj zaraženih u zadnjih 14 dana na 100000 stanovnika

![](img/2022_11_16_map_14_day_per_100k.png)

## Ukupan broj zaraženih u zadnjih 14 dana na 100000 stanovnika po regijama

(napomena: kod ECDC-a boja regije ovisi i o postotku pozitivnih testova, ovdje je prikazan samo broj slučajeva)

![](img/2022_11_16_map_14_day_per_100k_region.png)

## Ukupan broj zaraženih u zadnjih 7 dana na 100000 stanovnika po dobnim skupinama

![](img/2022_11_16_map_7_day_per_100k_age_groups.png)
...
![](img/2022_11_16_current_Jadranska_Hrvatska.png)

![](img/2022_11_16_current_Panonska_Hrvatska.png)

![](img/2022_11_16_current_Grad_Zagreb.png)

![](img/2022_11_16_current_Sjeverna_Hrvatska.png)

![](img/2022_11_16_current_Republika_Hrvatska.png)

![](img/2022_11_16_cases_hospitalisations_deaths_Republika_Hrvatska.png)

## Procijepljenost po županijama

(ne osvježava se automatski)

![](img/2022_11_16_vaccination.png)

## Pregled broja zaraženih po dobnim skupinama na 100000 stanovnika

(Podaci kasne par dana, prikazano stanje nije finalno.)

![](img/2022_11_16_per_age_group.png)

![](img/2022_11_16_per_age_group_all_0.png)

![](img/2022_11_16_per_age_group_all_1.png)

## Pregled broja zaraženih po dobnim skupinama i spolu (u zadnjih 7 dostupnih dana) na 100000 stanovnika

(Podaci kasne par dana, prikazano stanje nije finalno.)

![](img/2022_11_16_pyramid.png)
